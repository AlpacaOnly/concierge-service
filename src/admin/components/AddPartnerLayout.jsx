        ...
        <div className="container max-w-screen-lg mx-auto">
            ...
            <div className="bg-gray-100 rounded-xl shadow-lg p-4 px-4 md:p-8 mb-6">
                ...
                <div className="text-gray-600">
                    <p className="font-medium text-xl">Добавить партнера</p>
                    <p>Заполните все поля</p>
                </div>

                <div className="lg:col-span-2">Name
                    ...
                    <div className="md:col-span-2 text-left">
                        ...
                        <button onClick={() => navigate("/panel")} class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-xl">Отменить</button>
                        </div>
                    </div>
